...
describe('UserEventService', () => {
  ...
  describe('updateEventStatus', () => {
    it('should update event status successfully', async () => {
      ...
      const result = await UserEventService.updateEventStatus(
        'user1',
        'event1',
        'attending',
        'Updated notes',
  ...
  describe('getTrackedEventsByStatus', () => {
    it('should fetch tracked events by status', async () => {
      const mockTrackedEvents = [
        {
          id: 'tracking1',
          user_id: 'user1',
      ...
      const result = await UserEventService.getTrackedEventsByStatus(
        'user1',
        'attending',
        mockSupabase as unknown as SupabaseClient
      );
