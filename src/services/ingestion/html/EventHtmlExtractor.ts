...
function extractSpeakersFromJsonLd(eventPayload: Record<string, any>): SpeakerRecord[] {
    ...
    for (const performer of performers) {
        ...
        speakers.push({
            ...
            linkedinUrl: performer.sameAs && typeof performer.sameAs === 'string' && performer.sameAs.includes('linkedin.com')
                ? performer.sameAs
                : undefined,
            photoUrl: performer.image || performer.logo || undefined,
            githubUrl: performer.sameAs && typeof performer.sameAs === 'string' && performer.sameAs.includes('github.com')
                ? performer.sameAs
                : undefined,
        });
    }
