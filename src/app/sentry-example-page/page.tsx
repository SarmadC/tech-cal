...
export default function Page() {
  // Gate this page to non-production environments only
    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <a target="_blank" rel="noreferrer" href="https://kure-cal.sentry.io/issues/?project=4509771258200064">Issues Page</a>.
