...
describe('GET /api/mobile/speakers/[id]', () => {
  ...
  it('returns the signed-in mobile speaker payload', async () => {
    ...
    const response = await GET(new Request('http://localhost/api/mobile/speakers/speaker-1'), {
  ...
  it('returns 404 when the speaker does not exist', async () => {
    ...
    const response = await GET(new Request('http://localhost/api/mobile/speakers/missing'), {
