        ...
        <div className="bg-background-secondary rounded-2xl p-8 border border-border-color">
          <div className="space-y-6">
            ...
            <button
              ...
              className="w-full bg-accent-primary hover:bg-accent-primary-hover text-white font-semibold py-3 px-4 rounded-lg transition-all shadow-sm hover:shadow-md"
            >
              Sign in
            </button>
          </div>
