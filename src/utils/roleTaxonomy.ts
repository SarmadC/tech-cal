...
const ROLE_SYNONYM_MAP: Record<string, string[]> = {
  ...
  'Platform Engineer': ['platform engineer', 'developer platform engineer', 'internal platform engineer'],
  'Solutions Engineer': ['solutions engineer', 'sales engineer', 'solution consultant', 'pre-sales engineer'],
  'DevOps Engineer': ['devops', 'dev ops', 'infrastructure engineer', 'platform ops engineer', 'site reliability engineer'],
  ...
  'AI Engineer': ['ai engineer', 'applied ai engineer', 'genai engineer', 'generative ai engineer'],
  'Analytics Engineer': ['analytics engineer', 'dbt developer', 'analytics developer'],
  'ML Engineer': ['ml engineer', 'machine learning engineer', 'ml dev'],
  ...
  'Product Designer': ['product designer', 'product design', 'ux ui designer'],
  ...
  'Technical Product Manager': ['technical pm', 'technical product manager', 'tech product manager', 'technical product lead'],
  'Technical Program Manager': ['technical program manager', 'tpm', 'technical pgm', 'technical programme manager'],
  'Program Manager': ['program manager', 'pgm', 'programme manager'],
  'Product Marketing Manager': ['product marketing manager', 'product marketing', 'pmm'],
  'Growth Marketer': ['growth marketer', 'growth marketing', 'growth lead'],
  
  // Leadership roles
  'Founder': ['founder', 'cofounder', 'co-founder', 'startup founder'],
  'Entrepreneur / Startup Operator': ['entrepreneur', 'startup operator', 'operator', 'startup builder'],
  ...
  'Business Operations Manager': ['business operations manager', 'bizops', 'biz ops', 'business ops', 'strategy and ops'],
  'Developer Relations Manager': ['developer relations manager', 'devrel manager', 'developer relations lead', 'devrel lead'],
  'Community Manager': ['community manager', 'community lead', 'community ops', 'community operations lead'],
  'Customer Success Manager': ['customer success manager', 'customer success', 'csm', 'client success manager'],
