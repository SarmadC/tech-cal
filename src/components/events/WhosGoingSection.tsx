...
export default function WhosGoingSection({ eventId, className }: WhosGoingSectionProps) {
  ...
  if (isLoading) {
    return (
      <section className={className}>
        <span className="text-[11px] text-foreground-tertiary/70 block mb-2">Who&apos;s Going</span>
        <p className="text-[12px] text-foreground-tertiary/60">Loading attendees...</p>
      </section>
    );
  }
  ...
  if (authRequired) {
    return (
      <section className={className}>
        <span className="text-[11px] text-foreground-tertiary/70 block mb-2">Who&apos;s Going</span>
        <p className="text-[12px] text-foreground-tertiary/60">
          <Link href="/login" className="underline hover:text-foreground-secondary">
            Sign in
          </Link>{' '}
          to view attendees.
        </p>
  ...
  if (!data || (data.totalAttending <= 0 && !data.viewerIsAttending)) {
    return (
      <section className={className}>
        <span className="text-[11px] text-foreground-tertiary/70 block mb-2">Who&apos;s Going</span>
        <p className="text-[12px] text-foreground-tertiary/60">No one has marked attendance yet.</p>
      </section>
    );
  }
  ...
  return (
    <section className={className}>
      <span className="text-[11px] text-foreground-tertiary/70 block mb-2">Who&apos;s Going</span>
      <p className="text-[13px] text-foreground-primary">{summary}</p>
      <p className="text-[11px] text-foreground-tertiary/70 mt-1">{visibilityHint}</p>
