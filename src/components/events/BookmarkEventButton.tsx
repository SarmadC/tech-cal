    ...
    if (!user) {
        return (
            <Link
                ...
                className="flex items-center justify-center w-10 h-10 rounded-md bg-transparent text-foreground-tertiary hover:bg-background-tertiary/80 hover:text-foreground-primary transition-all"
