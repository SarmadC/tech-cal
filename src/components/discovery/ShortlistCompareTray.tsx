...
const ShortlistCompareTray: React.FC<ShortlistCompareTrayProps> = ({
    ...
    return (
        <div className="fixed bottom-20 md:bottom-6 right-4 left-4 md:left-auto md:w-[420px] z-[115] rounded-xl border border-border/80 bg-background/95 backdrop-blur-md shadow-xl">
