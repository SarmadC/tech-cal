...
export function AdminDataTable<T>({
    ...
    return (
        <div className="space-y-3">
            ...
            <div className="relative overflow-hidden rounded-lg border border-slate-800/60 bg-slate-950/60 shadow-sm">
                <div className={cn('relative max-h-[70vh] overflow-y-auto', stickyHeader && 'supports-[position:sticky]:[&_thead]:sticky supports-[position:sticky]:[&_thead]:top-0 supports-[position:sticky]:[&_thead]:z-10')}>
                    <Table className="min-w-full">
                        <TableHeader className="bg-slate-950/90 text-slate-300">
                                    ...
                                    >
                                        <button
                                            ...
                                            className={cn(
                                                ...
                                                sortKey === column.key.toString() && 'text-white'
                                            )}
                                            disabled={!column.sortable}
                                        >
                                            {column.header}
                                            {renderSortIndicator(column.key.toString(), column.sortable)}
                                        </button>
                                    </TableHead>
                                ))}
                            </TableRow>
            ...
            <div className="flex flex-col gap-3 rounded-lg border border-slate-800/60 bg-slate-950/60 px-4 py-3 text-sm text-slate-300 shadow-sm md:flex-row md:items-center md:justify-between">
