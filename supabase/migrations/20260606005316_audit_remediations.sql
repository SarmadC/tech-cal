...
REVOKE EXECUTE ON FUNCTION public.apply_event_update_queue_approval(p_queue_id uuid, p_reviewed_by uuid, p_scalar_updates jsonb, p_relationship_updates jsonb, p_speaker_updates jsonb, p_agenda_updates jsonb, p_approved_field_ids uuid[], p_rejected_field_ids uuid[], p_sanitized_field_updates jsonb, p_reject_remaining_pending boolean) FROM PUBLIC, anon, authenticated;
...
REVOKE EXECUTE ON FUNCTION public.claim_pending_source_events(p_limit integer, p_processing_status text) FROM PUBLIC, anon, authenticated;
...
REVOKE EXECUTE ON FUNCTION public.create_circle_post_with_rich_content(p_circle_id uuid, p_content text, p_post_type text, p_event_id uuid, p_mentions uuid[], p_media jsonb, p_title text) FROM PUBLIC, anon, authenticated;
...
REVOKE EXECUTE ON FUNCTION public.filter_events(p_search_term text, p_categories uuid[], p_start_date timestamp with time zone, p_end_date timestamp with time zone, p_event_format text, p_budget text, p_currency text, p_cost text, p_popularity text, p_duration text, p_my_network boolean, p_recommended boolean, p_page_num integer, p_page_size integer, p_sort_by text) FROM PUBLIC, anon, authenticated;
REVOKE EXECUTE ON FUNCTION public.find_event_by_external_id(p_external_id text, p_source text) FROM PUBLIC, anon, authenticated;
REVOKE EXECUTE ON FUNCTION public.find_similar_events(p_title text, p_start_time timestamp with time zone, p_similarity_threshold real, p_organizer_id uuid) FROM PUBLIC, anon, authenticated;
...
REVOKE EXECUTE ON FUNCTION public.log_webhook_event(p_source text, p_action text, p_external_id text, p_payload jsonb, p_signature_verified boolean) FROM PUBLIC, anon, authenticated;
...
REVOKE EXECUTE ON FUNCTION public.replace_event_agenda(p_event_id uuid, p_items jsonb) FROM PUBLIC, anon, authenticated;
...
REVOKE EXECUTE ON FUNCTION public.track_event_and_update_profile(p_user_id uuid, p_event_id uuid, p_status text, p_notes text) FROM PUBLIC, anon, authenticated;
...
GRANT EXECUTE ON FUNCTION public.apply_event_update_queue_approval(p_queue_id uuid, p_reviewed_by uuid, p_scalar_updates jsonb, p_relationship_updates jsonb, p_speaker_updates jsonb, p_agenda_updates jsonb, p_approved_field_ids uuid[], p_rejected_field_ids uuid[], p_sanitized_field_updates jsonb, p_reject_remaining_pending boolean) TO service_role;
...
GRANT EXECUTE ON FUNCTION public.claim_pending_source_events(p_limit integer, p_processing_status text) TO service_role;
...
GRANT EXECUTE ON FUNCTION public.create_circle_post_with_rich_content(p_circle_id uuid, p_content text, p_post_type text, p_event_id uuid, p_mentions uuid[], p_media jsonb, p_title text) TO authenticated, service_role;
...
GRANT EXECUTE ON FUNCTION public.filter_events(p_search_term text, p_categories uuid[], p_start_date timestamp with time zone, p_end_date timestamp with time zone, p_event_format text, p_budget text, p_currency text, p_cost text, p_popularity text, p_duration text, p_my_network boolean, p_recommended boolean, p_page_num integer, p_page_size integer, p_sort_by text) TO anon, authenticated, service_role;
GRANT EXECUTE ON FUNCTION public.find_event_by_external_id(p_external_id text, p_source text) TO service_role;
GRANT EXECUTE ON FUNCTION public.find_similar_events(p_title text, p_start_time timestamp with time zone, p_similarity_threshold real, p_organizer_id uuid) TO anon, authenticated, service_role;
...
GRANT EXECUTE ON FUNCTION public.log_webhook_event(p_source text, p_action text, p_external_id text, p_payload jsonb, p_signature_verified boolean) TO service_role;
...
GRANT EXECUTE ON FUNCTION public.replace_event_agenda(p_event_id uuid, p_items jsonb) TO service_role;
...
GRANT EXECUTE ON FUNCTION public.track_event_and_update_profile(p_user_id uuid, p_event_id uuid, p_status text, p_notes text) TO authenticated, service_role;
