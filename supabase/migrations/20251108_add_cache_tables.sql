...
DO $$ BEGIN
    ALTER TABLE public.page_cache ADD COLUMN IF NOT EXISTS source_domain text;
    ALTER TABLE public.extraction_job_log ADD COLUMN IF NOT EXISTS source_domain text;
EXCEPTION
